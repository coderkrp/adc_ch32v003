/*
 * Single-File-Header I2C Slave Library for CH32V003
 * Adapted from the ch32v003fun community project.
 */
...
static inline void SetupI2CSlave(uint8_t address, volatile uint8_t* registers, uint16_t size, i2c_write_callback_t write_callback, i2c_read_callback_t read_callback, bool read_only) {
...
static inline void SetupSecondaryI2CSlave(uint8_t address, volatile uint8_t* registers, uint16_t size, i2c_write_callback_t write_callback, i2c_read_callback_t read_callback, bool read_only) {
    if (address > 0) {
...
static inline void SetI2CSlaveReadOnly(bool read_only) {
    i2c_slave_state.read_only1 = read_only;
}

static inline void SetSecondaryI2CSlaveReadOnly(bool read_only) {
    i2c_slave_state.read_only2 = read_only;
}
